...
We can see that the preliminary decision tree predicted almost no "A"s. This makes sense, since only 2% of the students received an A whereas 47% received an F. Next steps would be to address this class imbalance before training a model.
